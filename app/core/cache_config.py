...
def load_cache_config_from_file(file_path: str) -> Optional[CacheSystemConfig]:
    ...
    try:
        ...
        config = CacheSystemConfig(
            ...
            redis_url=config_data.get("redis_url", "redis://redis:6379/0"),
        ...
        if "optimizer" in config_data:
            ...
            config.optimizer = OptimizerConfig(
                ...
                optimization_thresholds=optimizer_data.get(
                    "optimization_thresholds", {}
                ),
                max_concurrent_optimizations=optimizer_data.get(
        ...
        if "manager" in config_data:
            ...
            config.manager = ManagerConfig(
                ...
                enable_background_tasks=manager_data.get(
