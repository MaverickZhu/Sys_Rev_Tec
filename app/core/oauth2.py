...
from app.crud.crud_oauth2_client import oauth2_client, oauth2_authorization_code
...
class OAuth2Server:
    ...
    def __init__(self):
        ...
        self.access_token_expires_in = settings.JWT_ACCESS_TOKEN_EXPIRE_MINUTES * 60  # 转换为秒
        self.refresh_token_expires_in = settings.JWT_REFRESH_TOKEN_EXPIRE_DAYS * 24 * 60 * 60  # 转换为秒
