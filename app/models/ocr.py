...
class OCRResult(Base):
    ...
    # OCR处理信息
    ocr_engine = Column(String(50), nullable=False, default="tesseract", comment="OCR引擎")
    ...
    processed_by = Column(Integer, ForeignKey("users.id"), nullable=False, comment="处理者ID")
