...
class PerformanceMonitor:
    ...
    def _setup_metrics(self):
        ...
        self.error_rate = Gauge(
            "error_rate", "Application error rate", registry=self.registry
        )
    ...
    def record_ai_request(self, model: str, operation: str, duration: float):
        ...
        self.ai_request_duration.labels(model=model, operation=operation).observe(
            duration
        )
