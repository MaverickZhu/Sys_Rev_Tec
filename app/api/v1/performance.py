...
async def get_optimization_recommendations(current_user: User = Depends(get_current_user)):
    ...
    try:
        ...
        # 生成优化建议
        recommendations = enhanced_performance_monitor._generate_optimization_recommendations(
    ...
    try:
        return {
            ...
            "data": {
                ...
                "uptime": datetime.now().timestamp() - enhanced_performance_monitor._start_time,
                "alert_thresholds_count": len(enhanced_performance_monitor._alert_thresholds),
                "prometheus_registry_active": enhanced_performance_monitor.registry is not None,
                "timestamp": datetime.now().isoformat()
            }
        }
    except Exception as e:
