...
class ProductionDeployer:
    ...
    def check_prerequisites(self):
        ...
        try:
            ...
            if python_version.major < 3 or python_version.minor < 8:
                raise Exception(f"需要Python 3.8+，当前版本: {python_version.major}.{python_version.minor}")
    ...
    def run_database_migration(self):
        ...
        try:
            # 运行迁移脚本
            migration_script = self.project_root / "scripts" / "migrate_to_production.py"
...
"""
            ...
            logger.info(f"请将配置文件复制到Nginx配置目录并重新加载Nginx")
