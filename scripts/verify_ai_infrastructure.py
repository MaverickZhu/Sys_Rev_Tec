...
class AIInfrastructureVerifier:
    ...
    def __init__(self, verbose: bool = False, check_models: bool = False):
        ...
        # 配置信息
        self.config = {
            'database_url': os.getenv('DATABASE_URL', 'postgresql://postgres:sys_rev_password@localhost:5432/sys_rev_tech'),
    ...
    async def check_vector_tables(self) -> CheckResult:
        ...
        try:
            ...
            # 检查必要的表是否存在
            required_tables = ['document_vectors', 'vector_search_history', 'vector_index_stats']
            existing_tables = []
